...
if (moreBtn) moreBtn.onclick = () => { moreOpen = !moreOpen; if (morePanel) morePanel.classList.toggle("hidden", !moreOpen); updateLayoutVars(); resizeCanvas(); };
